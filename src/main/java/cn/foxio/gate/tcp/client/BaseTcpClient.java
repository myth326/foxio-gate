 ...
 *
 */
public class BaseTcpClient implements IChannelContainer{
	...
	protected FoxTcpClientHandler handler;
	...
	public BaseTcpClient(String host, int port, FoxTcpClientHandler handler , IChannelContainer channelContaier) {
		this.host = host;
		this.port = port;
	...
	public void reConnect(FoxTcpClientHandler hdl)
	{
		this.shutdown();
		this.handler = hdl;
		connect();
